...
const ModalCalendar: React.FC<ModalCalendarProps> = ({
  ...
  const handleCalendarIconClick = () => {
    ...
    )[0].children[0] as HTMLInputElement;
    datePickerInput.click();
  };

  return (
    <div
      className="modal-full bg-black-200 fixed top-0 left-0 w-full h-full flex justify-center items-center"
      onClick={handleCloseModal}
    >
      <div
        className="modal-content bg-yellow-50 p-4 rounded-md shadow-md max-w-md"
      ...
      >
        ...
        <DatePicker
          ...
          customInput={<div className="custom-input"></div>}
        />
        <button
          className="button-next bg-yellow-500 text-white font-semibold py-2 px-4 rounded mt-4"
          onClick={handleNext}
        >
          Далее
        </button>
